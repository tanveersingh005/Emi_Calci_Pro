  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 glass-panel p-6 rounded-2xl flex flex-col justify-between space-y-6">
          <div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-indigo-500/50 transition-all">
                ...
                <input
                  ...
                  className="bg-transparent font-bold text-sm w-36 outline-none text-slate-800 dark:text-slate-100"
                  min="0"
                  max="500000000"
                />
              </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-indigo-500/50 transition-all">
                <input
                  ...
                  className="bg-transparent font-bold text-sm w-16 text-right outline-none text-slate-800 dark:text-slate-100"
                  min="0"
                  max="50"
                />
                <span className="text-slate-400 dark:text-slate-500 text-sm font-bold ml-1">%</span>
              </div>
            </div>
            <input
              type="range"
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-3 py-1.5 focus-within:ring-2 focus-within:ring-indigo-500/50 transition-all">
                <input
                  ...
                  max="600"
                />
                <span className="text-slate-400 dark:text-slate-500 text-sm font-bold ml-1">months</span>
              </div>
            </div>
            <input
              type="range"
